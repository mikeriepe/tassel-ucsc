        ...
        >
          <MuiBox>
            <div>
              ...
              <p>{userProfile.volunteeringexperience[jobIndex].end !== '' ?
              (userProfile.volunteeringexperience[jobIndex].start + ' - ' +
              userProfile.volunteeringexperience[jobIndex].end) :
              userProfile.volunteeringexperience[jobIndex].start}</p>
